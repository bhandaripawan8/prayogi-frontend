            ...
            <div className="row">
              <div className="col-lg-3 col-sm-7 mb-4 mb-lg-0">
                ...
                <div className="footer_desc">
                  <p>
                    Phasellus blandit massa enim. elit id varius nunc. Lorems
                    ipsum dolor sit consectetur. If you are going to use a
                  ...
                  <li>
                    <div className="post_footer">
                      <div className="post_content">
                        <h6>
                          <a href="#">
                            Lorem ipsum dolor sit amet nullam consectetur
                            adipiscing elit.
                          </a>
                        </h6>
                        <span className="post_date">
                          <i className="ion-android-time"></i>April 14, 2018
                        </span>
                      </div>
                    </div>
                  </li>
                ...
                <div className="row">
                  <div className="col-md-6">
                    <p className="copyright m-md-0 text-center text-md-left">
                      Copyright © 2019 - Template Made By{" "}
                      <a
                        href="https://bestwebcreator.com/"
